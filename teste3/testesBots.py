...
def loc_enigma2(mensagem):
    ...
    if bloco_910.contains(loc_user):
        #print("chega aqui 3")
        bot.send_message(mensagem.chat.id, "Párabens, você encontrou o local correto. Agora, dirija-se ao LEC 2 ou a sala do PET para um petiano lhe guiar no próximo desafio.")
        #print("chega aqui 4")
